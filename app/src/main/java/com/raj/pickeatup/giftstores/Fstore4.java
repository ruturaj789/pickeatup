...
public class Fstore4 extends AppCompatActivity {
    ...
    Fstore4ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore4);
        rv=findViewById(R.id.rvfstore4);
        fab1=findViewById(R.id.fafstore4);
        bstoretimep1=findViewById(R.id.fstoretimep4);
        bstorenamep1=findViewById(R.id.fstorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore4.this, CartListFstore4.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore4ItemAdapter(Fstore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
