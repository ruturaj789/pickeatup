...
public class Fstore10 extends AppCompatActivity {
    ...
    Fstore10ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore10);
        rv=findViewById(R.id.rvfstore10);
        fab1=findViewById(R.id.fafstore10);
        bstoretimep1=findViewById(R.id.fstoretimep10);
        bstorenamep1=findViewById(R.id.fstorenamep10);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore10.this, CartListFstore10.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore10");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore10ItemAdapter(Fstore10.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore10.this, "Its showing database error", Toast.LENGTH_SHORT).show();
