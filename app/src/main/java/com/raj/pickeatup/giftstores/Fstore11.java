...
public class Fstore11 extends AppCompatActivity {
    ...
    Fstore11ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore11);
        rv=findViewById(R.id.rvfstore11);
        fab1=findViewById(R.id.fafstore11);
        bstoretimep1=findViewById(R.id.fstoretimep11);
        bstorenamep1=findViewById(R.id.fstorenamep11);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore11.this, CartListFstore11.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore11");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore11ItemAdapter(Fstore11.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore11.this, "Its showing database error", Toast.LENGTH_SHORT).show();
