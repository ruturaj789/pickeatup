...
public class Fstore3 extends AppCompatActivity {
    ...
    Fstore3ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore3);
        rv=findViewById(R.id.rvfstore3);
        fab1=findViewById(R.id.fafstore3);
        bstoretimep1=findViewById(R.id.fstoretimep3);
        bstorenamep1=findViewById(R.id.fstorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore3.this, CartListFstore3.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore3ItemAdapter(Fstore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
