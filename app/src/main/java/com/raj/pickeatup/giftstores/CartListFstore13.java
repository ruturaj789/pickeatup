...
public class CartListFstore13 extends AppCompatActivity {
    ...
    CartListFstore13Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_fstore13);

        rvcart=findViewById(R.id.rvcartfstore13);
        co=findViewById(R.id.cofstore13);
        totalprice=findViewById(R.id.totalpricesfstore13);
        totalsaving=findViewById(R.id.totalsavingsfstore13);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore13").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListFstore13Adapter(CartListFstore13.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListFstore13.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("fstore13").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("giftstore").child("fstore13");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListFstore13.this, AdressVishwa.class);
    ...
    Activity activity = CartListFstore13.this;
