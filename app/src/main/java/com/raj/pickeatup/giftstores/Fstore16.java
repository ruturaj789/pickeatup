...
public class Fstore16 extends AppCompatActivity {
    ...
    Fstore16ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore16);
        rv=findViewById(R.id.rvfstore16);
        fab1=findViewById(R.id.fafstore16);
        bstoretimep1=findViewById(R.id.fstoretimep16);
        bstorenamep1=findViewById(R.id.fstorenamep16);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore16.this, CartListFstore16.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore16");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore16ItemAdapter(Fstore16.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore16.this, "Its showing database error", Toast.LENGTH_SHORT).show();
