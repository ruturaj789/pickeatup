...
public class Fstore19 extends AppCompatActivity {
    ...
    Fstore19ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore19);
        rv=findViewById(R.id.rvfstore19);
        fab1=findViewById(R.id.fafstore19);
        bstoretimep1=findViewById(R.id.fstoretimep19);
        bstorenamep1=findViewById(R.id.fstorenamep19);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore19.this, CartListFstore19.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore19ItemAdapter(Fstore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
