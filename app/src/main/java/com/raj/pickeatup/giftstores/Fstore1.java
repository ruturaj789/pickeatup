...
public class Fstore1 extends AppCompatActivity {
    ...
    Fstore1ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore1);
        rv=findViewById(R.id.rvfstore1);
        fab1=findViewById(R.id.fafstore1);
        bstoretimep1=findViewById(R.id.fstoretimep1);
        bstorenamep1=findViewById(R.id.fstorenamep1);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore1.this, CartListFstore1.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore1");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore1ItemAdapter(Fstore1.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore1.this, "Its showing database error", Toast.LENGTH_SHORT).show();
