...
public class Fstore14 extends AppCompatActivity {
    ...
    Fstore14ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore14);
        rv=findViewById(R.id.rvfstore14);
        fab1=findViewById(R.id.fafstore14);
        bstoretimep1=findViewById(R.id.fstoretimep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore14.this, CartListFstore14.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore14ItemAdapter(Fstore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
