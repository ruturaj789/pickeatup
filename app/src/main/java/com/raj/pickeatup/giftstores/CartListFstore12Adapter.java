...
public class CartListFstore12Adapter extends RecyclerView.Adapter<com.raj.pickeatup.giftstores.CartListFstore12Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListFstore12Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListFstore12Adapter(CartListFstore12 cartListFstore12, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.giftstores.CartListFstore12Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.giftstores.CartListFstore12Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.giftstores.CartListFstore12Adapter.MyViewHolder holder, int position) {
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("fstore12");
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            ...
                            if(i==1)
                            {
                                ...
                                DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore12").child(uidno);
                                ...
                                cartListRef.child(titles).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent=new Intent(con, Fstore12.class);
