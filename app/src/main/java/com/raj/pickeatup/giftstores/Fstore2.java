...
public class Fstore2 extends AppCompatActivity {
    ...
    Fstore2ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore2);
        rv=findViewById(R.id.rvfstore2);
        fab1=findViewById(R.id.fafstore2);
        bstoretimep1=findViewById(R.id.fstoretimep2);
        bstorenamep1=findViewById(R.id.fstorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore2.this, CartListFstore2.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore2ItemAdapter(Fstore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
