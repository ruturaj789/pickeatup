...
public class Fstore6 extends AppCompatActivity {
    ...
    Fstore6ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore6);
        rv=findViewById(R.id.rvfstore6);
        fab1=findViewById(R.id.fafstore6);
        bstoretimep1=findViewById(R.id.fstoretimep6);
        bstorenamep1=findViewById(R.id.fstorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore6.this, CartListFstore6.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore6ItemAdapter(Fstore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
