...
public class Fstore7 extends AppCompatActivity {
    ...
    Fstore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore7);
        rv=findViewById(R.id.rvfstore7);
        fab1=findViewById(R.id.fafstore7);
        bstoretimep1=findViewById(R.id.fstoretimep7);
        bstorenamep1=findViewById(R.id.fstorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore7.this, CartListFstore7.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore7ItemAdapter(Fstore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
