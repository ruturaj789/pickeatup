...
public class Fstore20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fstore20);
        rv=findViewById(R.id.rvfstore20);
        fab1=findViewById(R.id.fafstore20);
        bstoretimep1=findViewById(R.id.fstoretimep20);
        bstorenamep1=findViewById(R.id.fstorenamep20);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore20.this, CartListFstore1.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore20");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore20ItemAdapter(Fstore20.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
