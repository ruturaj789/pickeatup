...
public class Fstore8 extends AppCompatActivity {
    ...
    Fstore8ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore8);
        rv=findViewById(R.id.rvfstore8);
        fab1=findViewById(R.id.fafstore8);
        bstoretimep1=findViewById(R.id.fstoretimep8);
        bstorenamep1=findViewById(R.id.fstorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore8.this, CartListFstore8.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore8ItemAdapter(Fstore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
