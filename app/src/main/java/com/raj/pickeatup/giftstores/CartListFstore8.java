...
public class CartListFstore8 extends AppCompatActivity {
    ...
    CartListFstore8Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_fstore8);

        rvcart=findViewById(R.id.rvcartfstore8);
        co=findViewById(R.id.cofstore8);
        totalprice=findViewById(R.id.totalpricesfstore8);
        totalsaving=findViewById(R.id.totalsavingsfstore8);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore8").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListFstore8Adapter(CartListFstore8.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListFstore8.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("fstore8").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("giftstore").child("fstore8");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListFstore8.this, AdressVishwa.class);
    ...
    Activity activity = CartListFstore8.this;
