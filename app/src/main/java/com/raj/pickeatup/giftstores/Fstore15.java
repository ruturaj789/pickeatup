...
public class Fstore15 extends AppCompatActivity {
    ...
    Fstore15ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore15);
        rv=findViewById(R.id.rvfstore15);
        fab1=findViewById(R.id.fafstore15);
        bstoretimep1=findViewById(R.id.fstoretimep15);
        bstorenamep1=findViewById(R.id.fstorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore15.this, CartListFstore15.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore15");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore15ItemAdapter(Fstore15.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore15.this, "Its showing database error", Toast.LENGTH_SHORT).show();
