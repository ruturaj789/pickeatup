...
public class Fstore17 extends AppCompatActivity {
    ...
    Fstore17ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore17);
        rv=findViewById(R.id.rvfstore17);
        fab1=findViewById(R.id.fafstore17);
        bstoretimep1=findViewById(R.id.fstoretimep17);
        bstorenamep1=findViewById(R.id.fstorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore17.this, CartListFstore17.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore17ItemAdapter(Fstore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
