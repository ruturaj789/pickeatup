...
public class Fstore12 extends AppCompatActivity {
    ...
    Fstore12ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore12);
        rv=findViewById(R.id.rvfstore12);
        fab1=findViewById(R.id.fafstore12);
        bstoretimep1=findViewById(R.id.fstoretimep12);
        bstorenamep1=findViewById(R.id.fstorenamep12);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore12.this, CartListFstore12.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore12ItemAdapter(Fstore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
