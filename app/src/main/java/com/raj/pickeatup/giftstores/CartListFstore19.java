...
public class CartListFstore19 extends AppCompatActivity {
    ...
    CartListFstore19Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_fstore19);

        rvcart=findViewById(R.id.rvcartfstore19);
        co=findViewById(R.id.cofstore19);
        totalprice=findViewById(R.id.totalpricesfstore19);
        totalsaving=findViewById(R.id.totalsavingsfstore19);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore19").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListFstore19Adapter(CartListFstore19.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListFstore19.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("fstore19").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("giftstore").child("fstore19");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListFstore19.this, AdressVishwa.class);
    ...
    Activity activity = CartListFstore19.this;
