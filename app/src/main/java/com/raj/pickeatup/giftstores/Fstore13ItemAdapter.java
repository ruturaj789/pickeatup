...
public class Fstore13ItemAdapter extends RecyclerView.Adapter<com.raj.pickeatup.giftstores.Fstore13ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Fstore13ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Fstore13ItemAdapter(Fstore13 fstore13, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.giftstores.Fstore13ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.giftstores.Fstore13ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.giftstores.Fstore13ItemAdapter.MyViewHolder holder, int position) {
...
//            final String s=numberButton.getNumber();
            ...
            numberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                    ...
                    if (!checkPermission(wantPermission)) {
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con, CartListFstore13.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore13");
