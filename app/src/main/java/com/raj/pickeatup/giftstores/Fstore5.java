...
public class Fstore5 extends AppCompatActivity {
    ...
    Fstore5ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore5);
        rv=findViewById(R.id.rvfstore5);
        fab1=findViewById(R.id.fafstore5);
        bstoretimep1=findViewById(R.id.fstoretimep5);
        bstorenamep1=findViewById(R.id.fstorenamep5);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore5.this, CartListFstore5.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore5");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore5ItemAdapter(Fstore5.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore5.this, "Its showing database error", Toast.LENGTH_SHORT).show();
