...
public class CartListFstore10 extends AppCompatActivity {
    ...
    CartListFstore10Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_fstore10);

        rvcart=findViewById(R.id.rvcartfstore10);
        co=findViewById(R.id.cofstore10);
        totalprice=findViewById(R.id.totalpricesfstore10);
        totalsaving=findViewById(R.id.totalsavingsfstore10);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("giftstores").child("fstore10").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListFstore10Adapter(CartListFstore10.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListFstore10.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("fstore10").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("giftstore").child("fstore10");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListFstore10.this, AdressVishwa.class);
    ...
    Activity activity = CartListFstore10.this;
