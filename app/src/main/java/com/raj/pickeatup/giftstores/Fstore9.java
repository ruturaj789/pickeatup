...
public class Fstore9 extends AppCompatActivity {
    ...
    Fstore9ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore9);
        rv=findViewById(R.id.rvfstore9);
        fab1=findViewById(R.id.fafstore9);
        bstoretimep1=findViewById(R.id.fstoretimep9);
        bstorenamep1=findViewById(R.id.fstorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore9.this, CartListFstore9.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore9ItemAdapter(Fstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
