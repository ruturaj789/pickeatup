...
public class Fstore18 extends AppCompatActivity {
    ...
    Fstore18ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fstore18);
        rv=findViewById(R.id.rvfstore18);
        fab1=findViewById(R.id.fafstore18);
        bstoretimep1=findViewById(R.id.fstoretimep18);
        bstorenamep1=findViewById(R.id.fstorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Fstore18.this, CartListFstore18.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("giftstores").child("fstore18");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Fstore18ItemAdapter(Fstore18.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Fstore18.this, "Its showing database error", Toast.LENGTH_SHORT).show();
