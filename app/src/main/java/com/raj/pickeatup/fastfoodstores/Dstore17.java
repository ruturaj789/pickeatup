...
public class Dstore17 extends AppCompatActivity {
    RecyclerView rv;

    FloatingActionButton fab1;

    ArrayList<ProfileOfItemsInVishwa> list;
    Dstore17ItemAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore17);
        rv=findViewById(R.id.rvdstore17);
        fab1=findViewById(R.id.fadstore17);
        bstoretimep1=findViewById(R.id.dstoretimep17);

        bstorenamep1=findViewById(R.id.dstorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore17.this, CartListDstore17.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore17ItemAdapter(Dstore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
