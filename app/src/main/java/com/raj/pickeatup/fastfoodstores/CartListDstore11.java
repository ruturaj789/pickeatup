...
public class CartListDstore11 extends AppCompatActivity {
    ...
    CartListDstore11Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_dstore11);

        rvcart=findViewById(R.id.rvcartdstore11);
        co=findViewById(R.id.codstore11);
        totalprice=findViewById(R.id.totalpricesdstore11);
        totalsaving=findViewById(R.id.totalsavingsdstore11);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("fastfoodstores").child("dstore11").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListDstore11Adapter(CartListDstore11.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListDstore11.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("dstore11").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("fastfoodstore").child("dstore11");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListDstore11.this, AdressVishwa.class);
    ...
    Activity activity = CartListDstore11.this;
