...
public class Dstore12 extends AppCompatActivity {
    ...
    Dstore12ItemAdapter myAdapter;
    TextView bstoretimep1;

    TextView bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore12);
        rv=findViewById(R.id.rvdstore12);
        fab1=findViewById(R.id.fadstore12);
        bstoretimep1=findViewById(R.id.dstoretimep12);

        bstorenamep1=findViewById(R.id.dstorenamep12);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore12.this, CartListDstore12.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore12ItemAdapter(Dstore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
