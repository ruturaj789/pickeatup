...
public class CartListDstore20 extends AppCompatActivity {
    ...
    CartListDstore20Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_dstore20);

        rvcart=findViewById(R.id.rvcartdstore20);
        co=findViewById(R.id.codstore20);
        totalprice=findViewById(R.id.totalpricesdstore20);
        totalsaving=findViewById(R.id.totalsavingsdstore20);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("fastfoodstores").child("dstore20").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListDstore20Adapter(CartListDstore20.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListDstore20.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("dstore20").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("fastfoodstore").child("dstore20");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListDstore20.this, AdressVishwa.class);
    ...
    Activity activity = CartListDstore20.this;
