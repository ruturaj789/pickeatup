...
public class Dstore15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore15);
        rv=findViewById(R.id.rvdstore15);
        fab1=findViewById(R.id.fadstore15);
        bstoretimep1=findViewById(R.id.dstoretimep15);

        bstorenamep1=findViewById(R.id.dstorenamep15);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore15.this, CartListDstore15.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore15");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore15ItemAdapter(Dstore15.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore15.this, "Its showing database error", Toast.LENGTH_SHORT).show();
