...
public class Dstore6 extends AppCompatActivity {
    ...
    Dstore6ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore6);
        rv=findViewById(R.id.rvdstore6);
        fab1=findViewById(R.id.fadstore6);
        bstoretimep1=findViewById(R.id.dstoretimep6);

        bstorenamep1=findViewById(R.id.dstorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore6.this, CartListDstore6.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore6ItemAdapter(Dstore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
