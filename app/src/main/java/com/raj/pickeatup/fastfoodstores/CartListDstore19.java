...
public class CartListDstore19 extends AppCompatActivity {
    ...
    CartListDstore19Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_dstore19);

        rvcart=findViewById(R.id.rvcartdstore19);
        co=findViewById(R.id.codstore1);
        totalprice=findViewById(R.id.totalpricesdstore19);
        totalsaving=findViewById(R.id.totalsavingsdstore19);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("fastfoodstores").child("dstore19").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListDstore19Adapter(CartListDstore19.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListDstore19.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("fastfoodstore").child("dstore19");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListDstore19.this, AdressVishwa.class);
    ...
    Activity activity = CartListDstore19.this;
