...
public class Dstore14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore14);
        rv=findViewById(R.id.rvdstore14);
        fab1=findViewById(R.id.fadstore14);
        bstoretimep1=findViewById(R.id.dstoretimep14);

        bstorenamep1=findViewById(R.id.dstorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore14.this, CartListDstore14.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore14ItemAdapter(Dstore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
