...
public class Dstore2 extends AppCompatActivity {
    ...
    Dstore2ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore2);
        rv=findViewById(R.id.rvdstore2);
        fab1=findViewById(R.id.fadstore2);
        bstoretimep1=findViewById(R.id.dstoretimep2);

        bstorenamep1=findViewById(R.id.dstorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore2.this, CartListDstore2.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore2ItemAdapter(Dstore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
