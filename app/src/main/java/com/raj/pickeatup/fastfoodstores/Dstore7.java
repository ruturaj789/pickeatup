...
public class Dstore7 extends AppCompatActivity {
    ...
    Dstore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore7);
        rv=findViewById(R.id.rvdstore7);
        fab1=findViewById(R.id.fadstore7);
        bstoretimep1=findViewById(R.id.dstoretimep7);


        bstorenamep1=findViewById(R.id.dstorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore7.this, CartListDstore7.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore7ItemAdapter(Dstore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
