...
public class Dstore3 extends AppCompatActivity {
    ...
    Dstore3ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore3);
        rv=findViewById(R.id.rvdstore3);
        fab1=findViewById(R.id.fadstore3);
        bstoretimep1=findViewById(R.id.dstoretimep3);

        bstorenamep1=findViewById(R.id.dstorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore3.this, CartListDstore3.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore3ItemAdapter(Dstore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
