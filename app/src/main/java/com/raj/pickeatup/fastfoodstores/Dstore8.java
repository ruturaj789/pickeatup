...
public class Dstore8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore8);
        rv=findViewById(R.id.rvdstore8);
        fab1=findViewById(R.id.fadstore8);
        bstoretimep1=findViewById(R.id.dstoretimep8);


        bstorenamep1=findViewById(R.id.dstorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore8.this, CartListDstore8.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore8ItemAdapter(Dstore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
