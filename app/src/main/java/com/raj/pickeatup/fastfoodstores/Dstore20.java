...
public class Dstore20 extends AppCompatActivity {
    RecyclerView rv;

    FloatingActionButton fab1;

    ArrayList<ProfileOfItemsInVishwa> list;
    Dstore20ItemAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore20);
        rv=findViewById(R.id.rvdstore20);
        fab1=findViewById(R.id.fadstore20);
        bstoretimep1=findViewById(R.id.dstoretimep20);

        bstorenamep1=findViewById(R.id.dstorenamep20);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore20.this, CartListDstore20.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore20");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore20ItemAdapter(Dstore20.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
