...
public class Dstore5 extends AppCompatActivity {
    RecyclerView rv;

    FloatingActionButton fab1;

    ArrayList<ProfileOfItemsInVishwa> list;
    Dstore5ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore5);
        rv=findViewById(R.id.rvdstore5);
        fab1=findViewById(R.id.fadstore5);
        bstoretimep1=findViewById(R.id.dstoretimep5);

        bstorenamep1=findViewById(R.id.dstorenamep5);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore5.this, CartListDstore5.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore5");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore5ItemAdapter(Dstore5.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore5.this, "Its showing database error", Toast.LENGTH_SHORT).show();
