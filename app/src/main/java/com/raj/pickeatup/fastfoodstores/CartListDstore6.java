...
public class CartListDstore6 extends AppCompatActivity {
    ...
    CartListDstore6Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_dstore6);

        rvcart=findViewById(R.id.rvcartdstore6);
        co=findViewById(R.id.codstore6);
        totalprice=findViewById(R.id.totalpricesdstore6);
        totalsaving=findViewById(R.id.totalsavingsdstore6);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("fastfoodstores").child("dstore6").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListDstore6Adapter(CartListDstore6.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListDstore6.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("dstore6").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("fastfoodstore").child("dstore6");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListDstore6.this, AdressVishwa.class);
    ...
    Activity activity = CartListDstore6.this;
