...
public class Dstore4 extends AppCompatActivity {
    RecyclerView rv;

    FloatingActionButton fab1;

    ArrayList<ProfileOfItemsInVishwa> list;
    Dstore4ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore4);
        rv=findViewById(R.id.rvdstore4);
        fab1=findViewById(R.id.fadstore4);
        bstoretimep1=findViewById(R.id.dstoretimep4);

        bstorenamep1=findViewById(R.id.dstorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore4.this, CartListDstore4.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore4ItemAdapter(Dstore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
