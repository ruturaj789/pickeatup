...
public class Dstore16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore16);
        rv=findViewById(R.id.rvdstore16);
        fab1=findViewById(R.id.fadstore16);
        bstoretimep1=findViewById(R.id.dstoretimep16);

        bstorenamep1=findViewById(R.id.dstorenamep16);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore16.this, CartListDstore16.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore16");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore16ItemAdapter(Dstore16.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore16.this, "Its showing database error", Toast.LENGTH_SHORT).show();
