...
public class Dstore13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore13);
        rv=findViewById(R.id.rvdstore13);
        fab1=findViewById(R.id.fadstore13);
        bstoretimep1=findViewById(R.id.dstoretimep13);

        bstorenamep1=findViewById(R.id.dstorenamep13);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore13.this, CartListDstore13.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore13");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore13ItemAdapter(Dstore13.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore13.this, "Its showing database error", Toast.LENGTH_SHORT).show();
