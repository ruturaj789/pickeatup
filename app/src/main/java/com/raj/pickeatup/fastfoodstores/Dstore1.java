...
import com.raj.pickeatup.breakfaststores.Cstore1ItemAdapter;

import java.util.ArrayList;

public class Dstore1 extends AppCompatActivity {
    ...
    Dstore1ItemAdapter myAdapter;
    TextView bstoretimep1, bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dstore1);
        rv=findViewById(R.id.rvdstore1);
        fab1=findViewById(R.id.fadstore1);


        bstoretimep1=findViewById(R.id.dstoretimep1);
        bstorenamep1=findViewById(R.id.dstorenamep1);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore1.this, CartListDstore1.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore1");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore1ItemAdapter(Dstore1.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore1.this, "Its showing database error", Toast.LENGTH_SHORT).show();
