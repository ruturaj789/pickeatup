...
public class Dstore9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore9);
        rv=findViewById(R.id.rvdstore9);
        fab1=findViewById(R.id.fadstore9);
        bstoretimep1=findViewById(R.id.dstoretimep9);

        bstorenamep1=findViewById(R.id.dstorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore9.this, CartListDstore9.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore9ItemAdapter(Dstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
