...
public class Dstore18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore18);
        rv=findViewById(R.id.rvdstore18);
        fab1=findViewById(R.id.fadstore18);
        bstoretimep1=findViewById(R.id.dstoretimep18);

        bstorenamep1=findViewById(R.id.dstorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore18.this, CartListDstore18.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore18");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore18ItemAdapter(Dstore18.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore18.this, "Its showing database error", Toast.LENGTH_SHORT).show();
