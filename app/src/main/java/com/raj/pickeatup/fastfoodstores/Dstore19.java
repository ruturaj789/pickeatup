...
public class Dstore19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dstore19);
        rv=findViewById(R.id.rvdstore19);
        fab1=findViewById(R.id.fadstore19);
        bstoretimep1=findViewById(R.id.dstoretimep19);

        bstorenamep1=findViewById(R.id.dstorenamep19);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Dstore19.this, CartListDstore19.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("fastfoodstores").child("dstore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Dstore19ItemAdapter(Dstore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Dstore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
