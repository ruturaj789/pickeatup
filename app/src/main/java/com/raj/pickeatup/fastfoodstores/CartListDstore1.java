...
import com.raj.pickeatup.breakfaststores.CartListCstore1;

import java.util.ArrayList;

public class CartListDstore1 extends AppCompatActivity {
    ...
    CartListDstore1Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_dstore1);

        rvcart=findViewById(R.id.rvcartdstore1);
        co=findViewById(R.id.codstore1);
        totalprice=findViewById(R.id.totalpricesdstore1);
        totalsaving=findViewById(R.id.totalsavingsdstore1);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("fastfoodstores").child("dstore1").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListDstore1Adapter(CartListDstore1.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListDstore1.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("dstore1").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("fastfoodstore").child("dstore1");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListDstore1.this, AdressVishwa.class);
                                        ...
                                        String storeid = "dstore1";

                                        String category = "fastfoodstores";
    ...
    Activity activity = CartListDstore1.this;
