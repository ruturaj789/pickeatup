...
public class CartListBstore1 extends AppCompatActivity {
    ...
    CartListBstore1Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore1);

        rvcart=findViewById(R.id.rvcartbstore1);
        co=findViewById(R.id.cobstore1);
        totalprice=findViewById(R.id.totalpricesbstore1);
        totalsaving=findViewById(R.id.totalsavingsbstore1);
...
//
//            Toast.makeText(CartListBstore1.this, uidno +"is this", Toast.LENGTH_SHORT).show();
//
//        }
//        else {


            reference = FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore1").child(uidno);
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        myadapter = new CartListBstore1Adapter(CartListBstore1.this, list);
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    ...
                    Toast.makeText(CartListBstore1.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

                }
            });


            reference2 = FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore1").child(uidno);
                    ...
                    if (snapshot.exists()) {
                        ...
                        co.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                DatabaseReference refe = FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore1");
                                refe.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                        ...
                                        if (snapshot2.exists()) {
                                            ...
                                            Intent i = new Intent(CartListBstore1.this, AdressVishwa.class);
                                            ...
                                            String storeid = "bstore1";

                                            String category = "bakerystores";
...
//    Activity activity = CartListBstore1.this;
