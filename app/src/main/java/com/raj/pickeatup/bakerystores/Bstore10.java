...
public class Bstore10 extends AppCompatActivity {
    ...
    Bstore10ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore10);
        rv=findViewById(R.id.rvbstore1);
        fab1=findViewById(R.id.fabstore1);


        bstoretimep1=findViewById(R.id.bstoretimep10);
        bstorenamep1=findViewById(R.id.bstorenamep10);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore10.this,CartListBstore10.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore10");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore10ItemAdapter(Bstore10.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore10.this, "Its showing database error", Toast.LENGTH_SHORT).show();
