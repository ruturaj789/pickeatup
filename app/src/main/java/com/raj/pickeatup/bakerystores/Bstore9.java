...
public class Bstore9 extends AppCompatActivity {
    ...
    Bstore9ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore9);
        rv=findViewById(R.id.rvbstore9);
        fab1=findViewById(R.id.fabstore9);



        bstoretimep1=findViewById(R.id.bstoretimep9);
        bstorenamep1=findViewById(R.id.bstorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore9.this,CartListBstore9.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore9ItemAdapter(Bstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
