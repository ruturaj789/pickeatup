...
public class Bstore2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bstore2);
        rv=findViewById(R.id.rvbstore2);
        fab1=findViewById(R.id.fabstore2);



        bstoretimep1=findViewById(R.id.bstoretimep2);
        bstorenamep1=findViewById(R.id.bstorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore2.this,CartListBstore2.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore2ItemAdapter(Bstore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
