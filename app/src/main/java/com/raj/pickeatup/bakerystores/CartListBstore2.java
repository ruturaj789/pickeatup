...
public class CartListBstore2 extends AppCompatActivity {
    ...
    CartListBstore2Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore2);

        rvcart=findViewById(R.id.rvcartbstore2);
        co=findViewById(R.id.cobstore2);
        totalprice=findViewById(R.id.totalpricesbstore2);
        totalsaving=findViewById(R.id.totalsavingsbstore2);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore2").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListBstore2Adapter(CartListBstore2.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListBstore2.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore2").child(uidno);
        ...
        reference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    final String totalprices = "Total= ₹" + snapshot.child("totalpeu").getValue().toString();
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore2");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListBstore2.this, AdressVishwa.class);
    ...
    Activity activity = CartListBstore2.this;
