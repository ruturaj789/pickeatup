...
public class Bstore4 extends AppCompatActivity {
    ...
    Bstore4ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore4);
        rv=findViewById(R.id.rvbstore4);
        fab1=findViewById(R.id.fabstore4);


        bstoretimep1=findViewById(R.id.bstoretimep4);
        bstorenamep1=findViewById(R.id.bstorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore4.this,CartListBstore4.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore4ItemAdapter(Bstore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
