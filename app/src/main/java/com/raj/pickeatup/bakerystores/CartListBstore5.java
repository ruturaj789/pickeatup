...
public class CartListBstore5 extends AppCompatActivity {
    ...
    CartListBstore5Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore5);

        rvcart=findViewById(R.id.rvcartbstore5);
        co=findViewById(R.id.cobstore5);
        totalprice=findViewById(R.id.totalpricesbstore5);
        totalsaving=findViewById(R.id.totalsavingsbstore5);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore5").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListBstore5Adapter(CartListBstore5.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListBstore5.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore5").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore5");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListBstore5.this, AdressVishwa.class);
    ...
    Activity activity = CartListBstore5.this;
