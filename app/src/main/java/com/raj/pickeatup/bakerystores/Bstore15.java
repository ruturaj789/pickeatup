...
public class Bstore15 extends AppCompatActivity {
    ...
    Bstore15ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore15);
        rv=findViewById(R.id.rvbstore15);
        fab1=findViewById(R.id.fabstore15);


        bstoretimep1=findViewById(R.id.bstoretimep15);
        bstorenamep1=findViewById(R.id.bstorenamep15);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore15.this,CartListBstore15.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore15");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore15ItemAdapter(Bstore15.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore15.this, "Its showing database error", Toast.LENGTH_SHORT).show();
