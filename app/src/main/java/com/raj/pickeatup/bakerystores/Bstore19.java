...
public class Bstore19 extends AppCompatActivity {
    ...
    Bstore19ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore19);
        rv=findViewById(R.id.rvbstore19);
        fab1=findViewById(R.id.fabstore19);


        bstoretimep1=findViewById(R.id.bstoretimep18);
        bstorenamep1=findViewById(R.id.bstorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore19.this,CartListBstore19.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore19ItemAdapter(Bstore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
