...
public class Bstore20 extends AppCompatActivity {
    ...
    DatabaseReference reference;
        ...
        Bstore20ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_bstore20);
            rv=findViewById(R.id.rvbstore20);
            fab1=findViewById(R.id.fabstore20);


            bstoretimep1=findViewById(R.id.bstoretimep20);
            bstorenamep1=findViewById(R.id.bstorenamep20);
                    ...
                    Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                            .setAction("View Cart", new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent i= new Intent(Bstore20.this,CartListBstore20.class);
            ...
            reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore20");
            ...
            reference.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    myAdapter=new Bstore20ItemAdapter(Bstore20.this,list);
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    ...
                    Toast.makeText(Bstore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
