...
public class Bstore3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bstore3);
        rv=findViewById(R.id.rvbstore3);
        fab1=findViewById(R.id.fabstore3);


        bstoretimep1=findViewById(R.id.bstoretimep3);
        bstorenamep1=findViewById(R.id.bstorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore3.this,CartListBstore3.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore3ItemAdapter(Bstore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
