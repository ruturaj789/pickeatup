...
import com.raj.pickeatup.CartListVishwa;
...
import com.raj.pickeatup.Vishwa;

import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Calendar;

public class CartListBstore1Adapter extends RecyclerView.Adapter<com.raj.pickeatup.bakerystores.CartListBstore1Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListBstore1Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListBstore1Adapter(CartListBstore1 cartListBstore1, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.bakerystores.CartListBstore1Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.bakerystores.CartListBstore1Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.bakerystores.CartListBstore1Adapter.MyViewHolder holder, int position) {
    ...
    //    String phoneno=getPhone();
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore1");
...
//
//            DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("godavari");
//
//
//            String saveCurrentDate, saveCurrentTime;
//
...
//            String quantity=quantityp.getText().toString();
//            String savings=savingp.getText().toString();




            //      int oneTypeProductTPrice=Integer.valueOf(peuprice) * Integer.valueOf(quantity);
            ...
            //       int oneTypeSaving=Integer.valueOf(savings) * Integer.valueOf(quantity);
            ...
            //     CartListVishwaAdapterHelper cartHelper= new CartListVishwaAdapterHelper( totalpeu,totalsaving,phoneno,saveCurrentDate,saveCurrentTime);

            //    cartListRef.child(phoneno).setValue(cartHelper);
...
//                                String phoneno=getPhone();
                                ...
                                DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore1").child(uidno);
                                ...
                                cartListRef.child(titles).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent=new Intent(con, Bstore1.class);
