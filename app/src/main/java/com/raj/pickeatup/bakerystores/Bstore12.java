...
public class Bstore12 extends AppCompatActivity {
    ...
    Bstore12ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore12);
        rv=findViewById(R.id.rvbstore12);
        fab1=findViewById(R.id.fabstore12);



        bstoretimep1=findViewById(R.id.bstoretimep11);
        bstorenamep1=findViewById(R.id.bstorenamep11);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore12.this,CartListBstore12.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore12ItemAdapter(Bstore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
