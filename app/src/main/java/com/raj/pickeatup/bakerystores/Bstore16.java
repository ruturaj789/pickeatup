...
public class Bstore16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bstoretimep1=findViewById(R.id.bstoretimep16);
        bstorenamep1=findViewById(R.id.bstorenamep16);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore16.this,CartListBstore16.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore16");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore16ItemAdapter(Bstore16.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore16.this, "Its showing database error", Toast.LENGTH_SHORT).show();
