...
public class Bstore7 extends AppCompatActivity {
    ...
    Bstore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore7);
        rv=findViewById(R.id.rvbstore7);
        fab1=findViewById(R.id.fabstore7);



        bstoretimep1=findViewById(R.id.bstoretimep7);
        bstorenamep1=findViewById(R.id.bstorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore7.this,CartListBstore7.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore7ItemAdapter(Bstore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
