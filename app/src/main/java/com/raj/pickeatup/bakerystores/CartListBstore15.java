...
public class CartListBstore15 extends AppCompatActivity {
    ...
    CartListBstore15Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore15);

        rvcart=findViewById(R.id.rvcartbstore15);
        co=findViewById(R.id.cobstore15);
        totalprice=findViewById(R.id.totalpricesbstore15);
        totalsaving=findViewById(R.id.totalsavingsbstore15);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore15").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListBstore15Adapter(CartListBstore15.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListBstore15.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore15").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore15");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListBstore15.this, AdressVishwa.class);
    ...
    Activity activity = CartListBstore15.this;
