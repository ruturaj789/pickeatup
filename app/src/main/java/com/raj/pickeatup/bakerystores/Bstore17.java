...
public class Bstore17 extends AppCompatActivity {
    ...
    Bstore17ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore17);
        rv=findViewById(R.id.rvbstore17);
        fab1=findViewById(R.id.fabstore17);


        bstoretimep1=findViewById(R.id.bstoretimep17);
        bstorenamep1=findViewById(R.id.bstorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore17.this,CartListBstore17.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore17ItemAdapter(Bstore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
