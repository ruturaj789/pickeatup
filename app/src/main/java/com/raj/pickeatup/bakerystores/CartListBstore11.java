...
public class CartListBstore11 extends AppCompatActivity {
    ...
    CartListBstore11Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore11);

        rvcart=findViewById(R.id.rvcartbstore11);
        co=findViewById(R.id.cobstore11);
        totalprice=findViewById(R.id.totalpricesbstore11);
        totalsaving=findViewById(R.id.totalsavingsbstore11);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore11").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListBstore11Adapter(CartListBstore11.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListBstore11.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore11").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore11");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListBstore11.this, AdressVishwa.class);
    ...
    Activity activity = CartListBstore11.this;
