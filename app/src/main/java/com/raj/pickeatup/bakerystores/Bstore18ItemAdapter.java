...
public class Bstore18ItemAdapter extends RecyclerView.Adapter<Bstore18ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Bstore18ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Bstore18ItemAdapter(Bstore1 bstore1, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public Bstore18ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Bstore18ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull Bstore18ItemAdapter.MyViewHolder holder, int position) {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con,CartListBstore18.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore18");
