...
public class Bstore6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bstore6);
        rv=findViewById(R.id.rvbstore6);
        fab1=findViewById(R.id.fabstore6);



        bstoretimep1=findViewById(R.id.bstoretimep6);
        bstorenamep1=findViewById(R.id.bstorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore6.this,CartListBstore6.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore6ItemAdapter(Bstore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
