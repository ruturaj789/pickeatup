...
public class CartListBstore16 extends AppCompatActivity {
    ...
    CartListBstore16Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_bstore16);

        rvcart=findViewById(R.id.rvcartbstore16);
        co=findViewById(R.id.cobstore16);
        totalprice=findViewById(R.id.totalpricesbstore16);
        totalsaving=findViewById(R.id.totalsavingsbstore16);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore16").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListBstore16Adapter(CartListBstore16.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListBstore16.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("bstore16").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bakerystore").child("bstore16");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListBstore16.this, AdressVishwa.class);
    ...
    Activity activity = CartListBstore16.this;
