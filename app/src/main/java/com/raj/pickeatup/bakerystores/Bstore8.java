...
public class Bstore8 extends AppCompatActivity {
    ...
    Bstore8ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore8);
        rv=findViewById(R.id.rvbstore8);
        fab1=findViewById(R.id.fabstore8);


        bstoretimep1=findViewById(R.id.bstoretimep8);
        bstorenamep1=findViewById(R.id.bstorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore8.this,CartListBstore8.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore8ItemAdapter(Bstore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
