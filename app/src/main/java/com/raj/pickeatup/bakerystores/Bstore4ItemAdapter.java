...
public class Bstore4ItemAdapter extends RecyclerView.Adapter<Bstore4ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Bstore4ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Bstore4ItemAdapter(Bstore4 bstore4, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public Bstore4ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Bstore4ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull Bstore4ItemAdapter.MyViewHolder holder, int position) {
...
//            final String s=numberButton.getNumber();
            ...
            numberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                     ...
                     //           Toast.makeText(con, numberButton.getNumber()+" "+titlep.getText() + " "+typep.getText()+"  Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con,CartListBstore4.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("bakerystores").child("bstore4");
