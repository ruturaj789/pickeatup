...
public class Bstore13 extends AppCompatActivity {
    ...
    Bstore13ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore13);
        rv=findViewById(R.id.rvbstore13);
        fab1=findViewById(R.id.fabstore13);


        bstoretimep1=findViewById(R.id.bstoretimep13);
        bstorenamep1=findViewById(R.id.bstorenamep13);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore13.this,CartListBstore13.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore13");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore13ItemAdapter(Bstore13.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore13.this, "Its showing database error", Toast.LENGTH_SHORT).show();
