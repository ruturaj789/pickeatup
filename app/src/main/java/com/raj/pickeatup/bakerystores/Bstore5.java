...
public class Bstore5 extends AppCompatActivity {
    ...
    Bstore5ItemAdapter myAdapter;

TextView bstoretimep1,bstorenamep1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore5);
        rv=findViewById(R.id.rvbstore5);
        fab1=findViewById(R.id.fabstore5);


        bstoretimep1=findViewById(R.id.bstoretimep5);
        bstorenamep1=findViewById(R.id.bstorenamep5);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore5.this,CartListBstore5.class);

                                String bstoreaddress_1=getIntent().getStringExtra("bstoreaddress_5");

                                String bstorename_1=getIntent().getStringExtra("bstorename_5");
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore5");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore5ItemAdapter(Bstore5.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore5.this, "Its showing database error", Toast.LENGTH_SHORT).show();
