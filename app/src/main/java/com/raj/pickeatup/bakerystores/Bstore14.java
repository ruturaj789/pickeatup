...
public class Bstore14 extends AppCompatActivity {
    ...
    Bstore14ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bstore14);
        rv=findViewById(R.id.rvbstore14);
        fab1=findViewById(R.id.fabstore14);


        bstoretimep1=findViewById(R.id.bstoretimep14);
        bstorenamep1=findViewById(R.id.bstorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Bstore14.this,CartListBstore14.class);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("bakerystores").child("bstore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Bstore14ItemAdapter(Bstore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Bstore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
