...
public class Estore2 extends AppCompatActivity {
    ...
    Estore2ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore2);
        rv=findViewById(R.id.rvestore2);
        fab1=findViewById(R.id.faestore2);
        bstoretimep1=findViewById(R.id.estoretimep2);
        bstorenamep1=findViewById(R.id.estorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore2.this, CartListEstore2.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore2ItemAdapter(Estore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
