...
public class Estore3 extends AppCompatActivity {
    ...
    Estore3ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore3);
        rv=findViewById(R.id.rvestore3);
        fab1=findViewById(R.id.faestore3);
        bstoretimep1=findViewById(R.id.estoretimep3);
        bstorenamep1=findViewById(R.id.estorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore3.this, CartListEstore3.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore3ItemAdapter(Estore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
