...
public class Estore11 extends AppCompatActivity {
    ...
    Estore11ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore11);
        rv=findViewById(R.id.rvestore11);
        fab1=findViewById(R.id.faestore11);
        bstoretimep1=findViewById(R.id.estoretimep11);
        bstorenamep1=findViewById(R.id.estorenamep11);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore11.this, CartListEstore11.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore11");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore11ItemAdapter(Estore11.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore11.this, "Its showing database error", Toast.LENGTH_SHORT).show();
