...
public class Estore10 extends AppCompatActivity {
    ...
    Estore10ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore10);
        rv=findViewById(R.id.rvestore10);
        fab1=findViewById(R.id.faestore10);
        bstoretimep1=findViewById(R.id.estoretimep10);
        bstorenamep1=findViewById(R.id.estorenamep10);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore10.this, CartListEstore10.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore10");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore10ItemAdapter(Estore10.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore10.this, "Its showing database error", Toast.LENGTH_SHORT).show();
