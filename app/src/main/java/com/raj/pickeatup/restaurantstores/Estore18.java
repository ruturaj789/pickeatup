...
public class Estore18 extends AppCompatActivity {
    ...
    Estore18ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore18);
        rv=findViewById(R.id.rvestore18);
        fab1=findViewById(R.id.faestore18);
        bstoretimep1=findViewById(R.id.estoretimep18);
        bstorenamep1=findViewById(R.id.estorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore18.this, CartListEstore18.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore18");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore18ItemAdapter(Estore18.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore18.this, "Its showing database error", Toast.LENGTH_SHORT).show();
