...
public class CartListEstore13 extends AppCompatActivity {
    ...
    CartListEstore13Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore13);

        rvcart=findViewById(R.id.rvcartestore13);
        co=findViewById(R.id.coestore13);
        totalprice=findViewById(R.id.totalpricesestore13);
        totalsaving=findViewById(R.id.totalsavingsestore13);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore13").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListEstore13Adapter(CartListEstore13.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore13.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore13").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore13");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore13.this, AdressVishwa.class);
    ...
    Activity activity = CartListEstore13.this;
