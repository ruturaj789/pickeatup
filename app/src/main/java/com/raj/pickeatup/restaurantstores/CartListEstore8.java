...
public class CartListEstore8 extends AppCompatActivity {
    ...
    CartListEstore8Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore8);

        rvcart=findViewById(R.id.rvcartestore8);
        co=findViewById(R.id.coestore8);
        totalprice=findViewById(R.id.totalpricesestore8);
        totalsaving=findViewById(R.id.totalsavingsestore8);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore8").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListEstore8Adapter(CartListEstore8.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore8.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore8").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore8");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore8.this, AdressVishwa.class);
    ...
    Activity activity = CartListEstore8.this;
