...
public class Estore12 extends AppCompatActivity {
    ...
    Estore12ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore12);
        rv=findViewById(R.id.rvestore12);
        fab1=findViewById(R.id.faestore12);
        bstoretimep1=findViewById(R.id.estoretimep12);
        bstorenamep1=findViewById(R.id.estorenamep12);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore12.this, CartListEstore12.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore12ItemAdapter(Estore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
