...
public class CartListEstore1Adapter extends RecyclerView.Adapter<com.raj.pickeatup.restaurantstores.CartListEstore1Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListEstore1Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListEstore1Adapter(CartListEstore1 cartListEstore1, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.restaurantstores.CartListEstore1Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.restaurantstores.CartListEstore1Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.restaurantstores.CartListEstore1Adapter.MyViewHolder holder, int position) {
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore1");
