...
import com.raj.pickeatup.bakerystores.CartListBstore1Adapter;
import com.raj.pickeatup.giftstores.CartListFstore1;

import java.util.ArrayList;

public class CartListEstore1 extends AppCompatActivity {
    ...
    CartListEstore1Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore1);

        rvcart=findViewById(R.id.rvcartestore1);
        co=findViewById(R.id.coestore1);
        totalprice=findViewById(R.id.totalpricesestore1);
        totalsaving=findViewById(R.id.totalsavingsestore1);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore1").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListEstore1Adapter(CartListEstore1.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore1.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore1").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore1");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore1.this, AdressVishwa.class);
                                        ...
                                        String storeid = "estore1";

                                        String category = "restaurantstores";
    ...
    Activity activity = CartListEstore1.this;
