...
public class Estore14 extends AppCompatActivity {
    ...
    Estore14ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore14);
        rv=findViewById(R.id.rvestore14);
        fab1=findViewById(R.id.faestore14);
        bstoretimep1=findViewById(R.id.estoretimep14);
        bstorenamep1=findViewById(R.id.estorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore14.this, CartListEstore14.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore14ItemAdapter(Estore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
