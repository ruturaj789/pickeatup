...
public class Estore17 extends AppCompatActivity {
    ...
    Estore17ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore17);
        rv=findViewById(R.id.rvestore17);
        fab1=findViewById(R.id.faestore17);
        bstoretimep1=findViewById(R.id.estoretimep17);
        bstorenamep1=findViewById(R.id.estorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore17.this, CartListEstore17.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore17ItemAdapter(Estore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
