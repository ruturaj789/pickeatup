...
public class Estore5 extends AppCompatActivity {
    ...
    Estore5ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore5);
        rv=findViewById(R.id.rvestore5);
        fab1=findViewById(R.id.faestore5);
        bstoretimep1=findViewById(R.id.estoretimep5);
        bstorenamep1=findViewById(R.id.estorenamep5);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore5.this, CartListEstore5.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore5");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore5ItemAdapter(Estore5.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore5.this, "Its showing database error", Toast.LENGTH_SHORT).show();
