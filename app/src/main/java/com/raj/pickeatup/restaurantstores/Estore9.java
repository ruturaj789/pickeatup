...
public class Estore9 extends AppCompatActivity {
    ...
    Estore9ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore9);
        rv=findViewById(R.id.rvestore9);
        fab1=findViewById(R.id.faestore9);
        bstoretimep1=findViewById(R.id.estoretimep9);
        bstorenamep1=findViewById(R.id.estorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore9.this, CartListEstore9.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore9ItemAdapter(Estore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
