...
public class Estore19 extends AppCompatActivity {
    ...
    Estore19ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore19);
        rv=findViewById(R.id.rvestore19);
        fab1=findViewById(R.id.faestore19);
        bstoretimep1=findViewById(R.id.estoretimep19);
        bstorenamep1=findViewById(R.id.estorenamep19);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore19.this, CartListEstore19.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore19ItemAdapter(Estore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
