...
public class Estore13 extends AppCompatActivity {
    ...
    Estore13ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore13);
        rv=findViewById(R.id.rvestore13);
        fab1=findViewById(R.id.faestore13);
        bstoretimep1=findViewById(R.id.estoretimep13);
        bstorenamep1=findViewById(R.id.estorenamep13);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore13.this, CartListEstore13.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore13");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore13ItemAdapter(Estore13.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore13.this, "Its showing database error", Toast.LENGTH_SHORT).show();
