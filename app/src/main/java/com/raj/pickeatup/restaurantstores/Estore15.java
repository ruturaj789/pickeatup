...
public class Estore15 extends AppCompatActivity {
    ...
    Estore15ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore15);
        rv=findViewById(R.id.rvestore15);
        fab1=findViewById(R.id.faestore15);
        bstoretimep1=findViewById(R.id.estoretimep15);
        bstorenamep1=findViewById(R.id.estorenamep15);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore15.this, CartListEstore15.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore15");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore15ItemAdapter(Estore15.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore15.this, "Its showing database error", Toast.LENGTH_SHORT).show();
