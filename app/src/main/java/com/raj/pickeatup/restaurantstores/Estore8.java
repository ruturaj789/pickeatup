...
public class Estore8 extends AppCompatActivity {
    ...
    Estore8ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore8);
        rv=findViewById(R.id.rvestore8);
        fab1=findViewById(R.id.faestore8);
        bstoretimep1=findViewById(R.id.estoretimep8);
        bstorenamep1=findViewById(R.id.estorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore8.this, CartListEstore8.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore8ItemAdapter(Estore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
