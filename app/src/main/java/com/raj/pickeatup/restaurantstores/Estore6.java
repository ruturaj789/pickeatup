...
public class Estore6 extends AppCompatActivity {
    ...
    Estore6ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore6);
        rv=findViewById(R.id.rvestore6);
        fab1=findViewById(R.id.faestore6);
        bstoretimep1=findViewById(R.id.estoretimep6);
        bstorenamep1=findViewById(R.id.estorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore6.this, CartListEstore6.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore6ItemAdapter(Estore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
