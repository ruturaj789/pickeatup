...
public class CartListEstore9 extends AppCompatActivity {
    ...
    CartListEstore9Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore9);

        rvcart=findViewById(R.id.rvcartestore9);
        co=findViewById(R.id.coestore9);
        totalprice=findViewById(R.id.totalpricesestore9);
        totalsaving=findViewById(R.id.totalsavingsestore9);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore9").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myadapter=new CartListEstore9Adapter(CartListEstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore9.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore9").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore9");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore9.this, AdressVishwa.class);
    ...
    Activity activity = CartListEstore9.this;
