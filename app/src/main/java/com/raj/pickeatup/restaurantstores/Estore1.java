...
public class Estore1 extends AppCompatActivity {
    ...
    Estore1ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore1);
        rv=findViewById(R.id.rvestore1);
        fab1=findViewById(R.id.faestore1);
        bstoretimep1=findViewById(R.id.estoretimep1);
        bstorenamep1=findViewById(R.id.estorenamep1);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore1.this, CartListEstore1.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore1");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore1ItemAdapter(Estore1.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore1.this, "Its showing database error", Toast.LENGTH_SHORT).show();
