...
public class CartListEstore14 extends AppCompatActivity {
    ...
    CartListEstore14Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore14);

        rvcart=findViewById(R.id.rvcartestore14);
        co=findViewById(R.id.coestore14);
        totalprice=findViewById(R.id.totalpricesestore14);
        totalsaving=findViewById(R.id.totalsavingsestore14);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore14").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListEstore14Adapter(CartListEstore14.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore14.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore14").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore14");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore14.this, AdressVishwa.class);
    ...
    Activity activity = CartListEstore14.this;
