...
public class CartListEstore10 extends AppCompatActivity {
    ...
    CartListEstore10Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_estore10);

        rvcart=findViewById(R.id.rvcartestore10);
        co=findViewById(R.id.coestore10);
        totalprice=findViewById(R.id.totalpricesestore10);
        totalsaving=findViewById(R.id.totalsavingsestore10);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("restaurantstores").child("estore10").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListEstore10Adapter(CartListEstore10.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListEstore10.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("estore10").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("restaurantstore").child("estore10");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListEstore10.this, AdressVishwa.class);
    ...
    Activity activity = CartListEstore10.this;
