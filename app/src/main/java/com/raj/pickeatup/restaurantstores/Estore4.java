...
public class Estore4 extends AppCompatActivity {
    ...
    Estore4ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore4);
        rv=findViewById(R.id.rvestore4);
        fab1=findViewById(R.id.faestore4);
        bstoretimep1=findViewById(R.id.estoretimep4);
        bstorenamep1=findViewById(R.id.estorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore4.this, CartListEstore4.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore4ItemAdapter(Estore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
