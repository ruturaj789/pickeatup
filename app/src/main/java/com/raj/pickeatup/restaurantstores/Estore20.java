...
public class Estore20 extends AppCompatActivity {
    ...
    Estore20ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore20);
        rv=findViewById(R.id.rvestore20);
        fab1=findViewById(R.id.faestore20);
        bstoretimep1=findViewById(R.id.estoretimep20);
        bstorenamep1=findViewById(R.id.estorenamep20);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore20.this, CartListEstore20.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore20");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore20ItemAdapter(Estore20.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
