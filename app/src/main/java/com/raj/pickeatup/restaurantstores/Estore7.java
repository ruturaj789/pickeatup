...
public class Estore7 extends AppCompatActivity {
    ...
    Estore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estore7);
        rv=findViewById(R.id.rvestore7);
        fab1=findViewById(R.id.faestore7);
        bstoretimep1=findViewById(R.id.estoretimep7);
        bstorenamep1=findViewById(R.id.estorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Estore7.this, CartListEstore7.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("restaurantstores").child("estore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Estore7ItemAdapter(Estore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Estore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
