...
public class CartListCstore11 extends AppCompatActivity {
    ...
    CartListCstore11Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_cstore11);

        rvcart=findViewById(R.id.rvcartcstore11);
        co=findViewById(R.id.cocstore11);
        totalprice=findViewById(R.id.totalpricescstore11);
        totalsaving=findViewById(R.id.totalsavingscstore11);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore11").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListCstore11Adapter(CartListCstore11.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListCstore11.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore11").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("breakfaststore").child("cstore11");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListCstore11.this, AdressVishwa.class);
    ...
    Activity activity = CartListCstore11.this;
