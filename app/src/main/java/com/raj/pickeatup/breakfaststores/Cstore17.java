...
public class Cstore17 extends AppCompatActivity {
    ...
    Cstore17ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore17);
        rv=findViewById(R.id.rvcstore17);
        fab1=findViewById(R.id.facstore17);
        bstoretimep1=findViewById(R.id.cstoretimep17);
        bstorenamep1=findViewById(R.id.cstorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore17.this, CartListCstore17.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore17ItemAdapter(Cstore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
