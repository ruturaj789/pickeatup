...
public class Cstore14 extends AppCompatActivity {
    ...
    Cstore14ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore14);
        rv=findViewById(R.id.rvcstore14);
        fab1=findViewById(R.id.facstore14);
        bstoretimep1=findViewById(R.id.cstoretimep14);
        bstorenamep1=findViewById(R.id.cstorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore14.this, CartListCstore14.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore14ItemAdapter(Cstore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
