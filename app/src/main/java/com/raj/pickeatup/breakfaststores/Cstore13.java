...
public class Cstore13 extends AppCompatActivity {
    ...
    Cstore13ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore13);
        rv=findViewById(R.id.rvcstore13);
        fab1=findViewById(R.id.facstore13);
        bstoretimep1=findViewById(R.id.cstoretimep13);
        bstorenamep1=findViewById(R.id.cstorenamep13);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore13.this, CartListCstore13.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore13");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore13ItemAdapter(Cstore13.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore13.this, "Its showing database error", Toast.LENGTH_SHORT).show();
