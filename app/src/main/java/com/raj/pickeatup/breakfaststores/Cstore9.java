...
public class Cstore9 extends AppCompatActivity {
    ...
    Cstore9ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore9);
        rv=findViewById(R.id.rvcstore9);
        fab1=findViewById(R.id.facstore9);
        bstoretimep1=findViewById(R.id.cstoretimep9);
        bstorenamep1=findViewById(R.id.cstorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore9.this, CartListCstore9.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore9ItemAdapter(Cstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
