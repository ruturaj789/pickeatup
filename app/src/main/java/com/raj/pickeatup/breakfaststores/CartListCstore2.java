...
public class CartListCstore2 extends AppCompatActivity {
    ...
    CartListCstore2Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_cstore2);

        rvcart=findViewById(R.id.rvcartcstore2);
        co=findViewById(R.id.cocstore2);
        totalprice=findViewById(R.id.totalpricescstore2);
        totalsaving=findViewById(R.id.totalsavingscstore2);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore2").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListCstore2Adapter(CartListCstore2.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListCstore2.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore2").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("breakfaststore").child("cstore2");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListCstore2.this, AdressVishwa.class);
    ...
    Activity activity = CartListCstore2.this;
