...
public class Cstore8 extends AppCompatActivity {
    ...
    Cstore8ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore8);
        rv=findViewById(R.id.rvcstore8);
        fab1=findViewById(R.id.facstore8);
        bstoretimep1=findViewById(R.id.cstoretimep8);
        bstorenamep1=findViewById(R.id.cstorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore8.this, CartListCstore8.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore8ItemAdapter(Cstore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
