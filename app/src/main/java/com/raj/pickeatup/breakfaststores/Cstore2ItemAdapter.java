...
public class Cstore2ItemAdapter extends RecyclerView.Adapter<com.raj.pickeatup.breakfaststores.Cstore2ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Cstore2ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Cstore2ItemAdapter(Cstore2 cstore2, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.breakfaststores.Cstore2ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.breakfaststores.Cstore2ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.breakfaststores.Cstore2ItemAdapter.MyViewHolder holder, int position) {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con, CartListCstore2.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore2");
