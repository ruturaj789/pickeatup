...
public class CartListCstore10 extends AppCompatActivity {
    ...
    CartListCstore10Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvcart=findViewById(R.id.rvcartcstore10);
        co=findViewById(R.id.cocstore10);
        totalprice=findViewById(R.id.totalpricescstore10);
        totalsaving=findViewById(R.id.totalsavingscstore10);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore10").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListCstore10Adapter(CartListCstore10.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListCstore10.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore10").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("breakfaststore").child("cstore10");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListCstore10.this, AdressVishwa.class);
    ...
    Activity activity = CartListCstore10.this;
