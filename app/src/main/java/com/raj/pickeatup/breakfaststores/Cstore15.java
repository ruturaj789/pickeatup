...
public class Cstore15 extends AppCompatActivity {
    ...
    Cstore15ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore15);
        rv=findViewById(R.id.rvcstore15);
        fab1=findViewById(R.id.facstore15);
        bstoretimep1=findViewById(R.id.cstoretimep15);
        bstorenamep1=findViewById(R.id.cstorenamep15);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore15.this, CartListCstore15.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore15");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore15ItemAdapter(Cstore15.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore15.this, "Its showing database error", Toast.LENGTH_SHORT).show();
