...
public class Cstore4 extends AppCompatActivity {
    ...
    Cstore4ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore4);
        rv=findViewById(R.id.rvcstore4);
        fab1=findViewById(R.id.facstore4);
        bstoretimep1=findViewById(R.id.cstoretimep4);
        bstorenamep1=findViewById(R.id.cstorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore4.this, CartListCstore4.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore4ItemAdapter(Cstore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
