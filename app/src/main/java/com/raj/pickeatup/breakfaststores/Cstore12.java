...
public class Cstore12 extends AppCompatActivity {
    ...
    Cstore12ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore12);
        rv=findViewById(R.id.rvcstore12);
        fab1=findViewById(R.id.facstore12);
        bstoretimep1=findViewById(R.id.cstoretimep12);
        bstorenamep1=findViewById(R.id.cstorenamep12);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore12.this, CartListCstore12.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore12ItemAdapter(Cstore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
