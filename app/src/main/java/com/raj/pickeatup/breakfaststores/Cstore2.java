...
public class Cstore2 extends AppCompatActivity {
    ...
    Cstore2ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore2);
        rv=findViewById(R.id.rvcstore2);
        fab1=findViewById(R.id.facstore2);

        bstoretimep1=findViewById(R.id.cstoretimep2);
        bstorenamep1=findViewById(R.id.cstorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore2.this, CartListCstore2.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore2ItemAdapter(Cstore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
