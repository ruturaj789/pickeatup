...
public class Cstore19 extends AppCompatActivity {
    ...
    Cstore19ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore19);
        rv=findViewById(R.id.rvcstore19);
        fab1=findViewById(R.id.facstore19);
        bstoretimep1=findViewById(R.id.cstoretimep19);
        bstorenamep1=findViewById(R.id.cstorenamep19);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore19.this, CartListCstore19.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore19ItemAdapter(Cstore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
