...
public class Cstore6 extends AppCompatActivity {
    ...
    Cstore6ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore6);
        rv=findViewById(R.id.rvcstore6);
        fab1=findViewById(R.id.facstore6);
        bstoretimep1=findViewById(R.id.cstoretimep6);
        bstorenamep1=findViewById(R.id.cstorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore6.this, CartListCstore6.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore6ItemAdapter(Cstore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
