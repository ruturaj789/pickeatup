...
public class CartListCstore16 extends AppCompatActivity {
    ...
    CartListCstore16Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_cstore16);

        rvcart=findViewById(R.id.rvcartcstore16);
        co=findViewById(R.id.cocstore16);
        totalprice=findViewById(R.id.totalpricescstore16);
        totalsaving=findViewById(R.id.totalsavingscstore16);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore16").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListCstore16Adapter(CartListCstore16.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListCstore16.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore16").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("breakfaststore").child("cstore16");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListCstore16.this, AdressVishwa.class);
    ...
    Activity activity = CartListCstore16.this;
