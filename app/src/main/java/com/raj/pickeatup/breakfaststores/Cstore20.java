...
public class Cstore20 extends AppCompatActivity {
    ...
    Cstore20ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore20);
        rv=findViewById(R.id.rvcstore20);
        fab1=findViewById(R.id.facstore20);
        bstoretimep1=findViewById(R.id.cstoretimep20);
        bstorenamep1=findViewById(R.id.cstorenamep20);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore20.this, CartListCstore20.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore20");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore20ItemAdapter(Cstore20.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
