...
public class Cstore10 extends AppCompatActivity {
    ...
    Cstore10ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore10);
        rv=findViewById(R.id.rvcstore10);
        fab1=findViewById(R.id.facstore10);
        bstoretimep1=findViewById(R.id.cstoretimep10);
        bstorenamep1=findViewById(R.id.cstorenamep10);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore10.this, CartListCstore10.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore10");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore10ItemAdapter(Cstore10.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore10.this, "Its showing database error", Toast.LENGTH_SHORT).show();
