...
public class Cstore18 extends AppCompatActivity {
    ...
    Cstore18ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore18);
        rv=findViewById(R.id.rvcstore18);
        fab1=findViewById(R.id.facstore18);
        bstoretimep1=findViewById(R.id.cstoretimep18);
        bstorenamep1=findViewById(R.id.cstorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore18.this, CartListCstore18.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore18");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore18ItemAdapter(Cstore18.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore18.this, "Its showing database error", Toast.LENGTH_SHORT).show();
