...
public class CartListCstore1Adapter extends RecyclerView.Adapter<com.raj.pickeatup.breakfaststores.CartListCstore1Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListCstore1Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListCstore1Adapter(CartListCstore1 cartListCstore1, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.breakfaststores.CartListCstore1Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.breakfaststores.CartListCstore1Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.breakfaststores.CartListCstore1Adapter.MyViewHolder holder, int position) {
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore1");
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            ...
                            if(i==1)
                            {
                                ...
                                DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore1").child(uidno);
                                ...
                                cartListRef.child(titles).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent=new Intent(con, Cstore1.class);
