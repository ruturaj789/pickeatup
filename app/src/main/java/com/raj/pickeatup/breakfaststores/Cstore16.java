...
public class Cstore16 extends AppCompatActivity {
    ...
    Cstore16ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore16);
        rv=findViewById(R.id.rvcstore16);
        fab1=findViewById(R.id.facstore16);
        bstoretimep1=findViewById(R.id.cstoretimep16);
        bstorenamep1=findViewById(R.id.cstorenamep16);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore16.this, CartListCstore16.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore16");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore16ItemAdapter(Cstore16.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore16.this, "Its showing database error", Toast.LENGTH_SHORT).show();
