...
public class Cstore3 extends AppCompatActivity {
    ...
    Cstore3ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore3);
        rv=findViewById(R.id.rvcstore3);
        fab1=findViewById(R.id.facstore3);
        bstoretimep1=findViewById(R.id.cstoretimep3);
        bstorenamep1=findViewById(R.id.cstorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore3.this, CartListCstore3.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore3ItemAdapter(Cstore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
