...
public class Cstore1 extends AppCompatActivity {
    ...
    Cstore1ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore1);
        rv=findViewById(R.id.rvcstore1);
        fab1=findViewById(R.id.facstore1);

        bstoretimep1=findViewById(R.id.cstoretimep1);
        bstorenamep1=findViewById(R.id.cstorenamep1);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore1.this, CartListCstore1.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore1");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore1ItemAdapter(Cstore1.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore1.this, "Its showing database error", Toast.LENGTH_SHORT).show();
