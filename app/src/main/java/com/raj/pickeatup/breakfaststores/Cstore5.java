...
public class Cstore5 extends AppCompatActivity {
    ...
    Cstore5ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore5);
        rv=findViewById(R.id.rvcstore5);
        fab1=findViewById(R.id.facstore5);
        bstoretimep1=findViewById(R.id.cstoretimep5);
        bstorenamep1=findViewById(R.id.cstorenamep5);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore5.this, CartListCstore5.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore5");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore5ItemAdapter(Cstore5.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore5.this, "Its showing database error", Toast.LENGTH_SHORT).show();
