...
public class Cstore11 extends AppCompatActivity {
    ...
    Cstore11ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore11);
        rv=findViewById(R.id.rvcstore11);
        fab1=findViewById(R.id.facstore11);
        bstoretimep1=findViewById(R.id.cstoretimep11);
        bstorenamep1=findViewById(R.id.cstorenamep11);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore11.this, CartListCstore11.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore11");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore11ItemAdapter(Cstore11.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore11.this, "Its showing database error", Toast.LENGTH_SHORT).show();
