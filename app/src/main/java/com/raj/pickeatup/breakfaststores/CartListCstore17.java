...
public class CartListCstore17 extends AppCompatActivity {
    ...
    CartListCstore17Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_cstore17);

        rvcart=findViewById(R.id.rvcartcstore17);
        co=findViewById(R.id.cocstore17);
        totalprice=findViewById(R.id.totalpricescstore17);
        totalsaving=findViewById(R.id.totalsavingscstore17);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore17").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListCstore17Adapter(CartListCstore17.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListCstore17.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore17").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("breakfaststore").child("cstore17");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListCstore17.this, AdressVishwa.class);
    ...
    Activity activity = CartListCstore17.this;
