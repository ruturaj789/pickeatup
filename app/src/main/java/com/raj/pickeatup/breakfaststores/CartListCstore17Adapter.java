...
public class CartListCstore17Adapter extends RecyclerView.Adapter<com.raj.pickeatup.breakfaststores.CartListCstore17Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListCstore17Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListCstore17Adapter(CartListCstore17 cartListCstore17, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.breakfaststores.CartListCstore17Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.breakfaststores.CartListCstore17Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.breakfaststores.CartListCstore17Adapter.MyViewHolder holder, int position) {
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("cstore17");
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            ...
                            if(i==1)
                            {
                                ...
                                DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore17").child(uidno);
                                ...
                                cartListRef.child(titles).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent=new Intent(con, Cstore17.class);
