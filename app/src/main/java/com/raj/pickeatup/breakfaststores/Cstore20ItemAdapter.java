...
public class Cstore20ItemAdapter extends RecyclerView.Adapter<com.raj.pickeatup.breakfaststores.Cstore20ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Cstore20ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Cstore20ItemAdapter(Cstore20 cstore20, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.breakfaststores.Cstore20ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.breakfaststores.Cstore20ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.breakfaststores.Cstore20ItemAdapter.MyViewHolder holder, int position) {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con, CartListCstore20.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("breakfaststores").child("cstore20");
