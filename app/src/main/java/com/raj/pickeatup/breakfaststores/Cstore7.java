...
public class Cstore7 extends AppCompatActivity {
    ...
    Cstore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cstore7);
        rv=findViewById(R.id.rvcstore7);
        fab1=findViewById(R.id.facstore7);
        bstoretimep1=findViewById(R.id.cstoretimep7);
        bstorenamep1=findViewById(R.id.cstorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Cstore7.this, CartListCstore7.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("breakfaststores").child("cstore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Cstore7ItemAdapter(Cstore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Cstore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
