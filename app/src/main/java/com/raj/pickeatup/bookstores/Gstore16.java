...
public class Gstore16 extends AppCompatActivity {
    ...
    Gstore16ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore16);
        rv=findViewById(R.id.rvgstore16);
        fab1=findViewById(R.id.fagstore16);
        bstoretimep1=findViewById(R.id.gstoretimep16);
        bstorenamep1=findViewById(R.id.gstorenamep1);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore16.this, CartListGstore16.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore16");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore16ItemAdapter(Gstore16.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore16.this, "Its showing database error", Toast.LENGTH_SHORT).show();
