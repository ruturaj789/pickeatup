...
public class Gstore7 extends AppCompatActivity {
    ...
    Gstore7ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore7);
        rv=findViewById(R.id.rvgstore7);
        fab1=findViewById(R.id.fagstore7);
        bstoretimep1=findViewById(R.id.gstoretimep7);
        bstorenamep1=findViewById(R.id.gstorenamep7);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore7.this, CartListGstore7.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore7");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore7ItemAdapter(Gstore7.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore7.this, "Its showing database error", Toast.LENGTH_SHORT).show();
