...
public class Gstore3 extends AppCompatActivity {
    ...
    Gstore3ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore3);
        rv=findViewById(R.id.rvgstore3);
        fab1=findViewById(R.id.fagstore3);
        bstoretimep1=findViewById(R.id.gstoretimep3);
        bstorenamep1=findViewById(R.id.gstorenamep3);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore3.this, CartListGstore3.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore3");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore3ItemAdapter(Gstore3.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore3.this, "Its showing database error", Toast.LENGTH_SHORT).show();
