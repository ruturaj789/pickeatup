...
public class Gstore12 extends AppCompatActivity {
    ...
    Gstore12ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore12);
        rv=findViewById(R.id.rvgstore12);
        fab1=findViewById(R.id.fagstore12);
        bstoretimep1=findViewById(R.id.gstoretimep12);
        bstorenamep1=findViewById(R.id.gstorenamep12);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore12.this, CartListGstore12.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore12");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore12ItemAdapter(Gstore12.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore12.this, "Its showing database error", Toast.LENGTH_SHORT).show();
