...
public class CartListGstore2 extends AppCompatActivity {
    ...
    CartListGstore2Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_gstore2);

        rvcart=findViewById(R.id.rvcartgstore2);
        co=findViewById(R.id.cogstore2);
        totalprice=findViewById(R.id.totalpricesgstore2);
        totalsaving=findViewById(R.id.totalsavingsgstore2);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore2").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListGstore2Adapter(CartListGstore2.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListGstore2.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("gstore2").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bookstore").child("gstore2");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListGstore2.this, AdressVishwa.class);
    ...
    Activity activity = CartListGstore2.this;
