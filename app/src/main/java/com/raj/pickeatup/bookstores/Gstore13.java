...
public class Gstore13 extends AppCompatActivity {
    ...
    Gstore13ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore13);
        rv=findViewById(R.id.rvgstore13);
        fab1=findViewById(R.id.fagstore13);
        bstoretimep1=findViewById(R.id.gstoretimep13);
        bstorenamep1=findViewById(R.id.gstorenamep13);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore13.this, CartListGstore13.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore13");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore13ItemAdapter(Gstore13.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore13.this, "Its showing database error", Toast.LENGTH_SHORT).show();
