...
public class CartListGstore17 extends AppCompatActivity {
    ...
    CartListGstore17Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_gstore17);

        rvcart=findViewById(R.id.rvcartgstore17);
        co=findViewById(R.id.cogstore17);
        totalprice=findViewById(R.id.totalpricesgstore17);
        totalsaving=findViewById(R.id.totalsavingsgstore17);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore17").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListGstore17Adapter(CartListGstore17.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListGstore17.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("gstore17").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bookstore").child("gstore17");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListGstore17.this, AdressVishwa.class);
    ...
    Activity activity = CartListGstore17.this;
