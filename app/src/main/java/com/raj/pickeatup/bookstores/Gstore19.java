...
public class Gstore19 extends AppCompatActivity {
    ...
    Gstore19ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore19);
        rv=findViewById(R.id.rvgstore19);
        fab1=findViewById(R.id.fagstore19);
        bstoretimep1=findViewById(R.id.gstoretimep19);
        bstorenamep1=findViewById(R.id.gstorenamep19);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore19.this, CartListGstore19.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore19");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore19ItemAdapter(Gstore19.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore19.this, "Its showing database error", Toast.LENGTH_SHORT).show();
