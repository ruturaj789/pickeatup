...
public class Gstore9 extends AppCompatActivity {
    ...
    Gstore9ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore9);
        rv=findViewById(R.id.rvgstore9);
        fab1=findViewById(R.id.fagstore9);
        bstoretimep1=findViewById(R.id.gstoretimep9);
        bstorenamep1=findViewById(R.id.gstorenamep9);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore9.this, CartListGstore9.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore9");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore9ItemAdapter(Gstore9.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore9.this, "Its showing database error", Toast.LENGTH_SHORT).show();
