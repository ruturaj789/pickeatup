...
public class Gstore2 extends AppCompatActivity {
    ...
    Gstore2ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore2);
        rv=findViewById(R.id.rvgstore2);
        fab1=findViewById(R.id.fagstore2);
        bstoretimep1=findViewById(R.id.gstoretimep2);
        bstorenamep1=findViewById(R.id.gstorenamep2);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore2.this, CartListGstore2.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore2");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore2ItemAdapter(Gstore2.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore2.this, "Its showing database error", Toast.LENGTH_SHORT).show();
