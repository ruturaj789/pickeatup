...
public class CartListGstore14Adapter extends RecyclerView.Adapter<com.raj.pickeatup.bookstores.CartListGstore14Adapter.MyViewHolder>{
    Context con;
    ...
    public CartListGstore14Adapter(Context c,ArrayList<ProfilesOfItemInCart> p)
    {
        con =c;
        profiles=p;
    }

    public CartListGstore14Adapter(CartListGstore14 cartListGstore14, String title, String type, String peuprice, String saving, String quantity) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.bookstores.CartListGstore14Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.bookstores.CartListGstore14Adapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.cartlistvishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.bookstores.CartListGstore14Adapter.MyViewHolder holder, int position) {
        ...
        DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("totalprice").child("gstore14");
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            ...
                            if(i==1)
                            {
                                ...
                                DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore14").child(uidno);
                                ...
                                cartListRef.child(titles).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent=new Intent(con, Gstore14.class);
