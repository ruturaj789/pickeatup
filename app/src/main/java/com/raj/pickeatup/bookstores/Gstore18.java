...
public class Gstore18 extends AppCompatActivity {
    ...
    Gstore18ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore18);
        rv=findViewById(R.id.rvgstore18);
        fab1=findViewById(R.id.fagstore18);
        bstoretimep1=findViewById(R.id.gstoretimep18);
        bstorenamep1=findViewById(R.id.gstorenamep18);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore18.this, CartListGstore18.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore18");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore18ItemAdapter(Gstore18.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore18.this, "Its showing database error", Toast.LENGTH_SHORT).show();
