...
public class Gstore17 extends AppCompatActivity {
    ...
    Gstore17ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore17);
        rv=findViewById(R.id.rvgstore17);
        fab1=findViewById(R.id.fagstore17);
        bstoretimep1=findViewById(R.id.gstoretimep17);
        bstorenamep1=findViewById(R.id.gstorenamep17);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore17.this, CartListGstore17.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore17");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore17ItemAdapter(Gstore17.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore17.this, "Its showing database error", Toast.LENGTH_SHORT).show();
