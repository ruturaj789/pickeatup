...
public class Gstore20 extends AppCompatActivity {
    ...
    Gstore20ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore20);
        rv=findViewById(R.id.rvgstore20);
        fab1=findViewById(R.id.fagstore20);
        bstoretimep1=findViewById(R.id.gstoretimep20);
        bstorenamep1=findViewById(R.id.gstorenamep20);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore20.this, CartListGstore20.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore20");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore20ItemAdapter(Gstore20.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore20.this, "Its showing database error", Toast.LENGTH_SHORT).show();
