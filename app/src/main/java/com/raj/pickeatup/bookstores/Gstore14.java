...
public class Gstore14 extends AppCompatActivity {
    ...
    Gstore14ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore14);
        rv=findViewById(R.id.rvgstore14);
        fab1=findViewById(R.id.fagstore14);
        bstoretimep1=findViewById(R.id.gstoretimep14);
        bstorenamep1=findViewById(R.id.gstorenamep14);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore14.this, CartListGstore14.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore14");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore14ItemAdapter(Gstore14.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore14.this, "Its showing database error", Toast.LENGTH_SHORT).show();
