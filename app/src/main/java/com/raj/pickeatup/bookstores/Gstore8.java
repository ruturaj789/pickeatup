...
public class Gstore8 extends AppCompatActivity {
    RecyclerView rv;

    FloatingActionButton fab1;

    ArrayList<ProfileOfItemsInVishwa> list;
    Gstore8ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore8);
        rv=findViewById(R.id.rvgstore8);
        fab1=findViewById(R.id.fagstore8);
        bstoretimep1=findViewById(R.id.gstoretimep8);
        bstorenamep1=findViewById(R.id.gstorenamep8);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore8.this, CartListGstore8.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore8");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore8ItemAdapter(Gstore8.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore8.this, "Its showing database error", Toast.LENGTH_SHORT).show();
