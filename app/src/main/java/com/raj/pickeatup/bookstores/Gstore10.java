...
public class Gstore10 extends AppCompatActivity {
    ...
    Gstore10ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore10);
        rv=findViewById(R.id.rvgstore10);
        fab1=findViewById(R.id.fagstore10);
        bstoretimep1=findViewById(R.id.gstoretimep10);
        bstorenamep1=findViewById(R.id.gstorenamep10);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore10.this, CartListGstore10.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore10");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore10ItemAdapter(Gstore10.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore10.this, "Its showing database error", Toast.LENGTH_SHORT).show();
