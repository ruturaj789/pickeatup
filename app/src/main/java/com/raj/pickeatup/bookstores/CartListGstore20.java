...
public class CartListGstore20 extends AppCompatActivity {
    ...
    CartListGstore20Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_gstore20);

        rvcart=findViewById(R.id.rvcartgstore20);
        co=findViewById(R.id.cogstore20);
        totalprice=findViewById(R.id.totalpricesgstore20);
        totalsaving=findViewById(R.id.totalsavingsgstore20);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore20").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListGstore20Adapter(CartListGstore20.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListGstore20.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("gstore20").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bookstore").child("gstore20");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListGstore20.this, AdressVishwa.class);
    ...
    Activity activity = CartListGstore20.this;
