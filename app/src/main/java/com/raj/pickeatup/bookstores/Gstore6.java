...
public class Gstore6 extends AppCompatActivity {
    ...
    Gstore6ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore6);
        rv=findViewById(R.id.rvgstore6);
        fab1=findViewById(R.id.fagstore6);
        bstoretimep1=findViewById(R.id.gstoretimep6);
        bstorenamep1=findViewById(R.id.gstorenamep6);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore6.this, CartListGstore6.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore6");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore6ItemAdapter(Gstore6.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore6.this, "Its showing database error", Toast.LENGTH_SHORT).show();
