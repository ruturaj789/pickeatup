...
public class CartListGstore7 extends AppCompatActivity {
    ...
    CartListGstore7Adapter myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_list_gstore7);

        rvcart=findViewById(R.id.rvcartgstore7);
        co=findViewById(R.id.cogstore7);
        totalprice=findViewById(R.id.totalpricesgstore7);
        totalsaving=findViewById(R.id.totalsavingsgstore7);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore7").child(uidno);
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()) {
                    ...
                    myadapter = new CartListGstore7Adapter(CartListGstore7.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CartListGstore7.this, "Please Check your mobile Internet Connection", Toast.LENGTH_SHORT).show();

            }
        });

        reference2=FirebaseDatabase.getInstance().getReference().child("totalprice").child("gstore7").child(uidno);
                ...
                if(snapshot.exists()) {
                    ...
                    co.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            DatabaseReference refe=FirebaseDatabase.getInstance().getReference().child("stores").child("bookstore").child("gstore7");
                            refe.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull final DataSnapshot snapshot2) {
                                    ...
                                    if(snapshot2.exists()) {
                                        ...
                                        Intent i = new Intent(CartListGstore7.this, AdressVishwa.class);
    ...
    Activity activity = CartListGstore7.this;
