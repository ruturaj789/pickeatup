...
public class Gstore4 extends AppCompatActivity {
    ...
    Gstore4ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore4);
        rv=findViewById(R.id.rvgstore4);
        fab1=findViewById(R.id.fagstore4);
        bstoretimep1=findViewById(R.id.gstoretimep4);
        bstorenamep1=findViewById(R.id.gstorenamep4);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore4.this, CartListGstore4.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore4");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore4ItemAdapter(Gstore4.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore4.this, "Its showing database error", Toast.LENGTH_SHORT).show();
