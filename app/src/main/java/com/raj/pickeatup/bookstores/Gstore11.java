...
public class Gstore11 extends AppCompatActivity {
    ...
    Gstore11ItemAdapter myAdapter;
    TextView bstoretimep1,bstorenamep1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gstore11);
        rv=findViewById(R.id.rvgstore11);
        fab1=findViewById(R.id.fagstore11);
        bstoretimep1=findViewById(R.id.gstoretimep11);
        bstorenamep1=findViewById(R.id.gstorenamep11);
                ...
                Snackbar.make(v,"Your PickEatUp Cart",Snackbar.LENGTH_LONG)
                        .setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i= new Intent(Gstore11.this, CartListGstore11.class);
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("bookstores").child("gstore11");
        ...
        reference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter=new Gstore11ItemAdapter(Gstore11.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Gstore11.this, "Its showing database error", Toast.LENGTH_SHORT).show();
