...
public class Gstore9ItemAdapter extends RecyclerView.Adapter<com.raj.pickeatup.bookstores.Gstore9ItemAdapter.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<ProfileOfItemsInVishwa> profiles;


    public Gstore9ItemAdapter(Context c,ArrayList<ProfileOfItemsInVishwa> p)
    {
        con =c;
        profiles=p;
    }

    public Gstore9ItemAdapter(Gstore9 gstore9, String title, String type, String mrp, String peuprice, String saving) {
    }


    @NonNull
    @Override
    public com.raj.pickeatup.bookstores.Gstore9ItemAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.raj.pickeatup.bookstores.Gstore9ItemAdapter.MyViewHolder(LayoutInflater.from(con).inflate(R.layout.vishwaitemcard,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.raj.pickeatup.bookstores.Gstore9ItemAdapter.MyViewHolder holder, int position) {
                ...
                public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                        ...
                        Snackbar.make(view,quantity+" "+title+" "+type+"  Added to Cart",Snackbar.LENGTH_SHORT).setAction("View Cart", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(con, CartListGstore9.class);
                    ...
                    DatabaseReference cartListRef= FirebaseDatabase.getInstance().getReference().child("cart").child("bookstores").child("gstore9");
